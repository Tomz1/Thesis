...
\def \cosupervisorname {Rui Maia}
\def \cosupervisoruniv {Instituto Superior Técnico}

\def \dissertationstatement {Dissertation submitted as partial fulfillment of the requirements for the degree of:}
\def \dissertationtitle {Master in Computer Science Engineering}

\begin{document}

\frontmatter

\title  {Modular Anomaly Detection Framework}
